(module
      (import "events" "piececrowned" (func $notify_piececrowned (param $x i32) (param $y i32)))
      (import "events" "piecemoved" (func $notify_piecemoved (param $fromX i32) (param $fromY i32) (param $toX i32) (param $toY i32) (param $p i32)))
    ...
    ;; Adds a crown to given piece (no mutation)
    (func $withCrown (param $piece i32) (result i32)
        (i32.or (get_local $piece) (get_global $CROWN))
    )

    ;; Removes a crown from given piece (no mutation)
    ...
    ;; Determine of a space is occupied without regard for who occupies it
    ...
    (func $validJumpDistance (param $from i32) (param $to i32) (result i32)
        ...
        ;; Return if the distance is less than equal to 2
        (i32.le_u
            (get_local $d)
            (i32.const 2)
        )
    ...
    ;; Exported 'move' function to be called from the game host
    (func $move (param $fromX i32) (param $fromY i32) (param $toX i32) (param $toY i32) (result i32)
        (if (result i32)
            ...
            (else
                (i32.const 0) ;; return 0 to show invalid move
            )
        )
    )
    ...
    (func $do_move (param $fromX i32) (param $fromY i32) (param $toX i32) (param $toY i32) (result i32)
        ...
        (call $notify_piecemoved (get_local $fromX) (get_local $fromY) (get_local $toX) (get_local $toY) (get_local $curpiece))
